...
import { 
  ...
  Clock, Calendar, Receipt,Moon, Sun, TrendingDown, TrendingUp as TrendIcon
} from 'lucide-react';
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Total Credit Limit</p>
              <p className="text-xl font-semibold text-[#005EFF]">R{creditDetails.totalLimit.toFixed(2)}</p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Available Credit</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
            <div className="flex justify-between items-center mb-2">
              <p className="text-gray-500 dark:text-gray-300">Credit Utilization</p>
    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Current Score</p>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Payment History</p>
              <div className="flex items-center">
                <p className="text-xl font-semibold text-green-600">
                  {creditDetails.paymentHistory.onTime}%
                </p>
                <span className="text-xs text-gray-500 dark:text-gray-300 ml-2">On-Time</span>
              </div>
              <div className="flex items-center mt-1">
                <p className="text-xl font-semibold text-red-600">
                  {creditDetails.paymentHistory.late}
                </p>
                <span className="text-xs text-gray-500 dark:text-gray-300 ml-2">Late Payments</span>
              </div>
            </div>
          </div>
        </div>
    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Total Amount</p>
              <p className="text-xl font-semibold text-[#005EFF]">R{bnpl.totalAmount.toFixed(2)}</p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Remaining Balance</p>
              <p className="text-xl font-semibold text-green-600">R{bnpl.remainingBalance.toFixed(2)}</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Monthly Payment</p>
              <p className="text-xl font-semibold text-gray-800 dark:text-white">R{bnpl.monthlyPayment.toFixed(2)}</p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
              <p className="text-gray-500 dark:text-gray-300 mb-2">Interest Rate</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl">
            <p className="text-gray-500 dark:text-gray-300 mb-2">Credit Terms</p>
            <div className="flex justify-between">
              <div>
                <p className="font-semibold text-gray-800 dark:text-white">{bnpl.monthsRemaining} Months Remaining</p>
                <p className="text-sm text-gray-500 dark:text-gray-300">Started: {bnpl.startDate}</p>
              </div>
              <button className="bg-[#005EFF] text-white px-4 py-2 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition">
                Modify Terms
              </button>
            </div>
          </div>
      ...
      <div className="flex-1 p-8 pt-5 overflow-y-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4 mt-4 md:mt-0">
            <button className={`flex items-center gap-2 px-4 py-2 text-sm border rounded-lg ${darkMode ? 'hover:bg-gray-50' : 'dark:border-gray-700 dark:hover:bg-gray-800'}`}>
              <Download className={`w-4 h-4 ${darkMode ? 'text-black' : 'dark:text-white'} `} />
              Download
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Available Credit */}
          <div 
            className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900"
            onClick={() => setSelectedDetailModal('available-credit')}
          >
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-gray-700 dark:text-gray-300 flex items-center gap-2">
                <CreditCardIcon className="w-5 h-5 dark:text-white" />
                Available Credit
          ...
          {/* Credit Score */}
          <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900"
            onClick={() => setSelectedDetailModal('credit-score')}
          >
           <div className="flex justify-between items-center mb-4">
              <h3 className="text-gray-700 dark:text-gray-300 flex items-center gap-2">
                <CircleGauge className="w-5 h-5 dark:text-white" />
                Credit Score
                <Info className="w-4 h-4 text-[#005EFF]" />
              </h3>
            </div>
        ...
        <div className="mt-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Buy Now, Pay Later Credits</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {bnplCredits.map(credit => (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-gray-700 dark:text-gray-300 flex items-center gap-2">
                    <Receipt className="w-5 h-5 dark:text-white" />
                    {credit.vendor}
                    <Info className="w-4 h-4 text-[#005EFF]" />
                  </h3>
                </div>
        ...
        <div className="mt-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm">
            {recentTransactions.map(transaction => (
              <div 
                key={transaction.id} 
                className="flex justify-between items-center p-4 border-b dark:border-gray-700 last:border-b-0 hover:bg-gray-50 dark:hover:bg-gray-700"
              >
                <div>
